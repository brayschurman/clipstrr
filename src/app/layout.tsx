...
export const metadata: Metadata = {
  title: "This One Part - Share YouTube Moments",
  description: "Share your favorite YouTube clips with friends in private rooms",
    ...
    <html lang="en" className={`${jetbrainsMono.variable}`}>
      <body className="relative min-h-screen overflow-x-hidden">
        <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden>
          ...
          <span className="absolute top-[8%] left-[104%] h-[3px] w-[3px] rounded-full bg-white animate-shooting-star-1" />
          <span className="absolute top-[18%] left-[102%] h-[2px] w-[2px] rounded-full bg-white animate-shooting-star-2" />
          <span className="absolute top-[38%] left-[102%] h-[2.5px] w-[2.5px] rounded-full bg-white animate-shooting-star-3" />
        </div>
        <TRPCReactProvider>
